...
public class LockInterface implements Runnable {
	String name;
	ReentrantLock re;

	public LockInterface(ReentrantLock rl, String n) {
		re = rl;
		name = n;
	}
	...
	public static void main(String[] args) {
		...
		Runnable w1 = new LockInterface(rel, "Job1");
		Runnable w2 = new LockInterface(rel, "Job2");
		Runnable w3 = new LockInterface(rel, "Job3");
		Runnable w4 = new LockInterface(rel, "Job4");
		pool.execute(w1);
		pool.execute(w2);
		pool.execute(w3);
		pool.execute(w4);
